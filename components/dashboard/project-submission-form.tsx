...
import { submitProjectWorkspaceWorkAction, type ProjectWorkspaceActionState } from "@/lib/projects/workspace-actions";
...
export function ProjectSubmissionForm({
  ...
  const [state, action, pending] = useActionState(submitProjectWorkspaceWorkAction, initialState);
    ...
    <form action={action} className="space-y-3 rounded-[1.5rem] bg-slate-50 p-4">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Describe the work you are submitting, what evidence is attached, and what you want the teacher to review."
        />
      </div>
      <div>
